  ...
  template: `
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200">
        <div class="px-8 py-6 bg-gradient-to-r from-blue-50 to-blue-100 border-b border-gray-200 flex items-center justify-between">
          <div>
            <h2 class="text-2xl font-bold text-blue-900">Users List</h2>
            <p class="text-sm text-blue-700 mt-1">Total users: <span class="font-semibold">{{users.length}}</span></p>
          </div>
          ...
          <table class=" table-auto min-w-full divide-y divide-gray-200">
            <thead class="bg-blue-50">
              <tr>
                ...
                <th class="px-6 py-3 text-left text-xs font-bold text-blue-700 uppercase tracking-wider bg-blue-100">
                  Actions
                </th>
              </tr>
            </thead>
            <tbody class="bg-white divide-y divide-gray-100">
              <tr *ngFor="let user of users; trackBy: trackByUserId" 
                ...
                <td *ngFor="let header of headers" 
                  ...
                  <input
                    *ngIf="editingUser === user && isEditableField(header); else displayValue"
                    type="text"
                    [value]="user[header]"
                  ...
                  <ng-template #displayValue>
                    <span [class.truncate]="shouldTruncate(user[header])" 
                          [title]="user[header]"
