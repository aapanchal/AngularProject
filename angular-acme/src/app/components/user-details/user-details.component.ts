...
@Component({
  ...
  template: `
    <div class="container mx-auto px-4 py-8">
      ...
      <div *ngIf="user; else userNotFound" class="bg-white rounded-lg shadow-lg overflow-hidden">
      ...
      <ng-template #userNotFound>
        <div class="bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <p class="text-gray-600 mb-6">The requested user could not be found.</p>
...
export class UserDetailsComponent implements OnInit {
  ...
  getDisplayName(): string {
    ...
    const nameFields = ['name', 'fullName', 'displayName', 'firstName', 'title'];
